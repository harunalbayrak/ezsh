...
if [ -d ~/.config/ezsh/oh-my-zsh/custom/plugins/alias-tips ]; then
    cd ~/.config/ezsh/oh-my-zsh/custom/plugins/alias-tips && git pull
else
    git clone --depth=1 https://github.com/djui/alias-tips ~/.config/ezsh/oh-my-zsh/custom/plugins/alias-tips
fi
